...
SumaNotasEstudiante1 = (float(Estudiante1["nota1"]))+(float(Estudiante1["nota2"]))+(float(Estudiante1["nota3"]))
SumaNotasEstudiante2 = (float(Estudiante2["nota1"]))+(float(Estudiante2["nota2"]))+(float(Estudiante2["nota3"]))
SumaNotasEstudiante3 = (float(Estudiante3["nota1"]))+(float(Estudiante3["nota2"]))+(float(Estudiante3["nota3"]))

PromedioEstudiante1 =(SumaNotasEstudiante1/3)
...
while repetir==0:
    ...
    if i == 1:
        ...
        if PromedioEstudiante1 > PromedioEstudiante2 and PromedioEstudiante1 > PromedioEstudiante3:
            print("El promedio mas alto es de: \n", Estudiante1, "\nPROMEDIO: \n", PromedioEstudiante1)
            print("------------------------------------------\n")
        elif PromedioEstudiante2 > PromedioEstudiante1 and PromedioEstudiante2 > PromedioEstudiante3:
            print("El promedio mas alto es de: \n", Estudiante2, "\nPROMEDIO: \n", PromedioEstudiante2)
            print("\n------------------------------------------\n")
        elif PromedioEstudiante3 > PromedioEstudiante1 and PromedioEstudiante3 > PromedioEstudiante2:
            print("El promedio mas alto es de: \n", Estudiante3, "\nPROMEDIO: \n", PromedioEstudiante3)
            print("\n------------------------------------------\n")
    elif i == 9:
        if PromedioEstudiante1 < PromedioEstudiante2 and PromedioEstudiante1 < PromedioEstudiante3:
        ...
        print("ERROR, Elija una de las 9 opciones disponibles.\n")
